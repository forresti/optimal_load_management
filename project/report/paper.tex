...
%\begin{table}[t]
%\caption{Optimizing LMS reduces load shedding compared to the LL-LMS load shedding policy.}
%\label{T:example-1}
%\centering
\begin{tabular}{c|cc}
...
Timestep 2 (live data):
    Load Shedding Priority Table:
    Load 1: 20,000W, least preferred to shed.
    Load 2: 40,000W, second-least preferred to shed
    Load 3: 40,000W, most preferred to shed
