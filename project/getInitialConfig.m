...
function config = getInitialConfig(constants)
    ...
    BusUsed1 = [1 0 0]; %Del1 in Mehdi's code. Use Gen1 for Bus1
    BusUsed2 = [0 1 0]; %Del1 in Mehdi's code. Use Gen2 for Bus2
    ...
    config = struct('Shedding1', Shedding1, 'Shedding2', Shedding2, 'BusUsed1', BusUsed1, 'BusUsed2', BusUsed2, 'Battery1', Battery1, 'Battery2', Battery2, 'GeneratorOnOff', GeneratorOnOff)
end 
