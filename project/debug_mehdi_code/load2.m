function [Ls1,Lns1,Ls2,Lns2]=load2(N)
...
Ls1(7,:)=zeros(1,N); Ls1(7, 2*N/10:5*N/10 )=5000; Ls1(7, 7*N/10:9*N/10 )=5000;
...
Ls2(7,:)=zeros(1,N); Ls2(7, N/10:4*N/10)=5000; Ls2(7,5*N/10:7*N/10)=29000; % 5000
